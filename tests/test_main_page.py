...
def test_main_page(browser, config):
    ...
    wait_while_open_demoqa = main_page.wait_presence_of_element_located((By.XPATH, Main.ELEMENT_IMG))
    check_is_displayed_element_img = main_page.check_is_displayed_img(browser, By.XPATH, Main.ELEMENT_IMG)
