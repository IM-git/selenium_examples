...
# ALERT BUTTON
    click_alert_button = alerts_page.click_element(
        By.XPATH, Alerts.ID_ALERT_BUTTON)
...
# CONFIRM BOX 'Ok'
    ...
    get_confirm_result_text_ok = alerts_page.get_text(
        By.XPATH, Alerts.GET_CONFIRM_RESULT_TEXT)
...
# PROMPT BOX EMPTY 'Ok'
    click_alert_button_witch_prompt_box = alerts_page.click_element(
        By.XPATH, Alerts.ID_ALERT_BUTTON_WITCH_PROMPT_BOX)
...
# PROMPT BOX 'Ok' WITH TEXT
    ...
    enter_text_in_alert_prompt = alerts_page.enter_text_in_alert_prompt(
        Alerts.ENTER_TEXT_IN_ALERT_PROMPT)
    alert_click_ok = alerts_page.alert_click_ok(Alerts.TIME_DEFAULT)
